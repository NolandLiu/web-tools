...
export const TOOL_CONTRACTS = {
  ...
  cheque: qualityContract({
    ...
    rule: "parse exact integer minor units from text and format general English and Traditional Chinese financial words",
    output: { format: "two independently labeled and copyable amount strings without a currency name" },
    limitations: ["bank and regional writing conventions vary; output is a writing aid"],
