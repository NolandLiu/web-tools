export const CATEGORY_CONTENT = {
  ...
  "network-ip": {
    en: {
      introduction: "Network and IP tools inspect address notation, subnet boundaries, and IPv6 prefix ranges entirely in the browser.",
      useCases: ["Plan IPv4 subnet boundaries or summarize exact IPv4 ranges.", "Normalize IPv6 addresses and calculate prefix ranges without sending network data outside the browser."],
      distinction: "Choose this category for local IP addressing work. It does not include IP geolocation, RDAP, DNS, port scanning, domain WHOIS, risk scoring, or bulk lookup.",
    },
    "zh-CN": {
      introduction: "网络与 IP 工具用于在浏览器本地检查地址表示、子网边界和 IPv6 前缀范围。",
      useCases: ["规划 IPv4 子网边界或汇总精确 IPv4 范围。", "规范化 IPv6 地址并计算前缀范围，不把网络数据发送到浏览器外。"],
      distinction: "当任务涉及本地 IP 地址处理时选择本分类。本分类不包含 IP 地理位置、RDAP、DNS、端口扫描、域名 WHOIS、风险评分或批量查询。",
    },
    "zh-TW": {
      introduction: "網絡與 IP 工具用於在瀏覽器本機檢查位址表示、子網邊界和 IPv6 前綴範圍。",
      useCases: ["規劃 IPv4 子網邊界或彙總精確 IPv4 範圍。", "規範化 IPv6 位址並計算前綴範圍，不把網絡資料傳送到瀏覽器外。"],
      distinction: "當工作涉及本機 IP 位址處理時選擇本分類。本分類不包含 IP 地理位置、RDAP、DNS、連接埠掃描、網域 WHOIS、風險評分或批次查詢。",
    },
  },
};
